...
import { findComment as findCommentService, isAuthorized, deleteComment as deleteCommentService, createComment as createCommentService, getComment as getCommentService, updateComment as updateCommentService, } from "../services/commentService.ts";
const createComment = async (req, res) => {
    try {
        const { ParentId, PostId, content } = req?.body;
        const comment = await createCommentService(req?.user?.id, PostId, content, ParentId);
        if (!comment) {
            return res
